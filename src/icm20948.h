...
#ifndef __cplusplus
extern int memcmp(const void *, const void *, size_t); // Avoid compiler warnings (C only)
#endif
...
icm20948_status_e icm20948_link_serif(icm20948_device_t *pdev,
                                      const icm20948_serif_t *s); // Links a SERIF structure to the device

// use the device's serif to perform a read or write
icm20948_status_e icm20948_execute_r(icm20948_device_t *pdev, uint8_t regaddr, uint8_t *pdata,
...
icm20948_status_e icm20948_i2c_controller_periph4_txn(icm20948_device_t *pdev, uint8_t addr, uint8_t reg, uint8_t *data,
...
icm20948_status_e icm20948_sw_reset(icm20948_device_t
                                    *pdev);                                               // Performs a SW reset
icm20948_status_e icm20948_sleep(icm20948_device_t *pdev,
...
icm20948_status_e icm20948_set_clock_source(icm20948_device_t *pdev,
...
icm20948_status_e icm20948_check_id(icm20948_device_t
                                    *pdev);                                               // Return 'ICM_20948_STAT_OK' if whoami matches ICM_20948_WHOAMI
icm20948_status_e icm20948_data_ready(icm20948_device_t
                                      *pdev);                                             // Returns 'Ok' if data is ready

// Interrupt Configuration
icm20948_status_e icm20948_int_pin_cfg(icm20948_device_t *pdev, icm20948_int_pin_cfg_t *write,
                                       icm20948_int_pin_cfg_t *read); // Set the INT pin configuration
icm20948_status_e icm20948_int_enable(icm20948_device_t *pdev, icm20948_int_enable_t *write,
                                      icm20948_int_enable_t
                                      *read);    // Write and or read the interrupt enable information. If non-null the write operation occurs before the read, so as to verify that the write was successful

// WoM Enable Logic configuration
icm20948_status_e icm20948_wom_logic(icm20948_device_t *pdev, icm20948_accel_intel_ctrl_t *write,
                                     icm20948_accel_intel_ctrl_t *read); //Enable or disable WoM Logic

// WoM Threshold Level Configuration
icm20948_status_e icm20948_wom_threshold(icm20948_device_t *pdev, icm20948_accel_wom_thr_t *write,
...
icm20948_status_e icm20948_set_sample_mode(icm20948_device_t *pdev, icm20948_internal_sensor_id_bm sensors,
        icm20948_lp_config_cycle_e mode); // Use to set accel, gyro, and I2C master into cycled or continuous modes
icm20948_status_e icm20948_set_full_scale(icm20948_device_t *pdev, icm20948_internal_sensor_id_bm sensors,
        icm20948_fss_t fss);
icm20948_status_e icm20948_set_dlpf_cfg(icm20948_device_t *pdev, icm20948_internal_sensor_id_bm sensors,
...
icm20948_status_e icm20948_set_sample_rate(icm20948_device_t *pdev, icm20948_internal_sensor_id_bm sensors,
...
icm20948_status_e icm20948_i2c_controller_configure_peripheral(icm20948_device_t *pdev, uint8_t peripheral, uint8_t addr,
        uint8_t reg, uint8_t len, bool Rw, bool enable, bool data_only, bool grp, bool swap, uint8_t dataOut);
...
*/
icm20948_status_e inv_icm20948_firmware_load(icm20948_device_t *pdev, const unsigned char *data, unsigned short size,
...
*/
icm20948_status_e inv_icm20948_write_mems(icm20948_device_t *pdev, unsigned short reg, unsigned int length,
...
*  @return     0 if successful.
*/
icm20948_status_e inv_icm20948_read_mems(icm20948_device_t *pdev, unsigned short reg, unsigned int length,
        unsigned char *data);

icm20948_status_e inv_icm20948_set_dmp_sensor_period(icm20948_device_t *pdev, enum DMP_ODR_Registers odr_reg,
        uint16_t interval);
icm20948_status_e inv_icm20948_enable_dmp_sensor(icm20948_device_t *pdev, enum inv_icm20948_sensor sensor,
        int state);     // State is actually boolean
icm20948_status_e inv_icm20948_enable_dmp_sensor_int(icm20948_device_t *pdev, enum inv_icm20948_sensor sensor,
        int state); // State is actually boolean
